...
// Création d'un schema mongoose pour que les données de la base MongoDB ne puissent pas différer de
...
// On exporte ce schéma de données, on va donc pouvoir utiliser ce modèle pour intéragir avec l'application
